...
export default function Newsletter(){
    return (
        <div className="flex bg-[#FFA920] h-25 px-3 sm:px-3 md:px-5 md:gap-0.5 sm:w-[70%] items-center sm:rounded-b-2xl justify-around mb-5 w-full sm:mb-10">
            <div className="text-white font-nunito font-bold">Subscribe To Our News Letter</div>
            <div className="flex justify-between bg-white text-gray-400 font-nunito text-sm rounded-full h-9 md:w-90">
                <input type="email" placeholder="Enter Email Address" className="p-4 font-bold text-gray-500 text-xs" />
                <img src="/images/button.png" alt="news letter icon" className="hidden sm:block sm:m-1 sm:bg-[#FFA920] sm:rounded-full"/>
            </div>
            <div className="sm:flex sm:flex-row sm:gap-2 hidden sm:block ">
<svg
  className="w-8 h-8 text-[#FFA920] bg-white rounded-full p-1"
  viewBox="0 0 24 24"
  fill="currentColor"
>
  <path d="M22 12.07C22 6.48 17.52 2 11.93 2S1.86 6.48 1.86 12.07c0 5 3.66 9.13 8.44 9.93v-7.03H7.9v-2.9h2.4V9.85c0-2.37 1.41-3.68 3.57-3.68 1.03 0 2.1.18 2.1.18v2.31h-1.18c-1.16 0-1.52.72-1.52 1.46v1.75h2.59l-.41 2.9h-2.18V22c4.78-.8 8.44-4.93 8.44-9.93z"/>
   ...
   <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#FFA920] bg-white rounded-full w-8 h-8 p-2" viewBox="0 0 16 16">
  <path d="M12.6 0.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867 -5.07 -4.425 5.07H0.316l5.733 -6.57L0 0.75h5.063l3.495 4.633L12.601 0.75Zm-0.86 13.028h1.36L4.323 2.145H2.865z" stroke-width="1"></path>
</svg>
<svg fill="currentColor" className="text-[#FFA920] w-8 h-8 p-2 bg-white rounded-full" xmlns="http://www.w3.org/2000/svg"
...
<svg fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg"
	 className="text-[#FFA920] w-8 h-8 p-2 bg-white rounded-full" viewBox="0 0 96.875 96.875">
<g>
